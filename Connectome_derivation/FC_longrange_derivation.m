...
% TODO('For Publish uncomment as the surface file to big to share');
surface_dist = squareform(pdist(surface_to_analyze.vertices(cortex_ind,:)));

% load so I don't have to always calculate
%load('/Users/jakub/Matlab/Collaboration_Deco/project_laplacian/empirical/euclidean_distance_matrix.mat','surface_dist')
